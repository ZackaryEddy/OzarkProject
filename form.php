...
<div id="all-contents">
    <nav>
        <!--<header>Wild River Rapids</header-->
        <img src = https://pbs.twimg.com/media/C2iwRDlWEAA4omC.jpg:large  height = "52" width = "52" alt = "logo">
        <img src = https://pbs.twimg.com/media/C2iwRDlWEAA4omC.jpg:large  height = "52" width = "52" alt = "logo">
        <header></header>
        ...
        <ul>
            ...
            <li><a href="store.html">Country Bar</a></li>
